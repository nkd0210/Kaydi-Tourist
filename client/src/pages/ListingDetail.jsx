...
const ListingDetail = () => {
    ...
    return (
        <Wrapper>
            <div className='mx-[50px] my-[20px] flex flex-col gap-[20px]'>
                <Link to='/'>
                    <FaHome className='text-[30px] max-md:text-[20px]' />
                </Link>
                ...
                <div className='flex justify-between gap-[20px] max-md:flex-col border-[3px] border-gray-300 border-x-0 border-b-0 pt-[20px]'>
                    ...
                    <div>
                        ...
                        <div className=''>
                            ...
                            <div className='pl-[20px] border border-gray-300 shadow-lg rounded-[10px] py-[20px] '>
                                ...
                                <button className='border bg-red-400 text-white rounded-[10px] py-[10px] px-[20px] mt-[10px] hover:bg-opacity-70 cursor-pointer'>
                                    Booking
                                </button>
                            </div>
