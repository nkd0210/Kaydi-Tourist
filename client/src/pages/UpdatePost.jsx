...
const UpdatePost = () => {
    ...
    const handleUpdateForm = async (e) => {
        ...
        const postForm = {
            ...
            content: describe || defaultPost.content,
            image: formDataImage.listingPhotoPaths || defaultPost.image
        }
        ...
        try {
            ...
            const data = await res.json();
            if (!res.ok) {
                handleShowErrorMessage("Failed to update post")
                return;
            } else {
    ...
    return (
        <div>
            ...
            <div className='mx-[100px] max-md:mx-[10px] my-[50px] max-md:my-[20px]'>
                <h2 className='text-center text-[30px] font-semibold mb-[50px]'>Update Your Post</h2>
                {loading ? (
                    <Loader />
                ) : (
                    <form onSubmit={handleUpdateForm} className='bg-white p-[20px] flex flex-col gap-[40px]'>
                        {/* TITLE */}
                        <div className='flex gap-[20px] items-center'>
                            ...
                            <input defaultValue={defaultPost?.title} onChange={(e) => setTitle(e.target.value)} type="text" placeholder="Enter your title here" required className='border rounded-[20px] p-[10px] w-[300px] h-[50px] shadow-md' />
                        </div>
                        ...
                        <div className='flex flex-col gap-[20px]'>
                            ...
                            <textarea defaultValue={defaultPost.content} onChange={(e) => setDescribe(e.target.value)} placeholder='Write something here...' className='border h-[200px] p-[10px]'>
                            </textarea>
